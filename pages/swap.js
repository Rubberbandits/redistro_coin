		...
		<>
			...
			<main className="min-h-screen">
				<header className="body-font">
					<div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
						...
						<nav className="md:ml-auto flex flex-col sm:flex-row flex-wrap items-center text-base justify-center">
							...
							<Link href="/stake">
								<button className="btn btn-primary btn-wide mb-2 sm:w-min sm:mb-0 sm:mr-5">Stake</button>
							</Link>
						</nav>
					</div>
				</header>
				...
				<div className="w-full h-max">
					<iframe src={`https://traderjoexyz.com/#/trade?outputCurrency=${ERC20_ADDRESS}`} style={{width: "100%", height: "90.5vh"}} title="TraderJoe Swap" />
				</div>
			</main>
		</>
	)
